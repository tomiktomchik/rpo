...
Java_ru_iu3_chel_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
#include "C:/Users/nlint/AndroidStudioProjects/libs/mbedtls/mbedtls/include/mbedtls/entropy.h"
#include "C:/Users/nlint/AndroidStudioProjects/libs/mbedtls/mbedtls/include/mbedtls/ctr_drbg.h"
#include "C:/Users/nlint/AndroidStudioProjects/libs/mbedtls/mbedtls/include/mbedtls/des.h"
...
Java_ru_iu3_chel_MainActivity_initRng(
        JNIEnv *env,
        jclass clazz ) {
...
Java_ru_iu3_chel_MainActivity_randomBytes(
        JNIEnv *env,
        jclass clazz,
        jint n ) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_chel_MainActivity_encrypt(
        JNIEnv *env,
        jclass clazz,
        jbyteArray key,
        jbyteArray data ) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_chel_MainActivity_decrypt(
        JNIEnv *env,
        jclass clazz,
        jbyteArray key,
        jbyteArray data ) {
